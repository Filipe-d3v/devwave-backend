...
module.exports = class UserController {
    static async create(req, res) {
        const { name, surname, email, phone, gender, address, description,
            birth, cep, city, uf, password, confirm_pass, nationality, github, linkedin } = req.body
    ...
    static async update(req, res) {
        ...
        const { name, surname, email, phone, gender, address, description,
             birth, cep, city, uf, password, confirm_pass, github, linkedin, nationality } = req.body
